            ...
            bootstrapVersion: s, sprintf: function (e) {
                ...
                for (var v = 0; v < e.length; v++) {
                    ...
                    try {
                        for (var g, f = e[v][Symbol.iterator](); !(c = (g = f.next()).done); c = !0) {
                            var b = g.value, r = b.rowspan || 1, m = b.colspan || 1, w = o[v].indexOf(!1);
                ...
                try {
                    for (var n, s = Object.entries(e)[Symbol.iterator](); !(t = (n = s.next()).done); t = !0) {
                        var l = n.value, r = i(l, 2), d = r[0], p = r[1],
        ...
        var c = function () {
            ...
            return o(t, [{
                    ...
                    if (this.$header = this.$el.find('>thead'), this.$header.length || (this.$header = n('<thead class="' + this.options.theadClasses + '"></thead>').appendTo(this.$el)), this.$header.find('tr').each(function (e, t) {
                        ...
                        this.$el.find('>tbody>tr').each(function (t, o) {
                            ...
                            s._id = n(o).attr('id'), s._class = n(o).attr('class'), s._data = r.getRealDataAttr(n(o).data()), n(o).find('>td').each(function (o, i) {
                                ...
                                for (var h = p; h < p + l; h++) for (var u = t; u < t + d; u++) a[u] || (a[u] = []), a[u][h] = !0;
                ...
                key: 'initPagination', value: function () {
                    ...
                    var t = [], o = !1, a = void 0, i = void 0, s = void 0, d = void 0, p = void 0, c = void 0,
                        h = void 0, u = this.getData(), g = this.options.pageList;
                    if ('server' !== this.options.sidePagination && (this.options.totalRows = u.length), this.totalPages = 0, this.options.totalRows) {
                        if (this.options.pageSize === this.options.formatAllRows()) this.options.pageSize = this.options.totalRows, o = !0; else if (this.options.pageSize === this.options.totalRows) {
                    ...
                    if (!this.hiddenRows.includes(e)) {
                        if (s = r.calculateObjectValue(this.options, this.options.rowStyle, [e, t], s), s && s.css) {
                            ...
                            try {
                                for (var f, b = Object.entries(s.css)[Symbol.iterator](); !(h = (f = b.next()).done); h = !0) {
                                    var m = f.value, w = i(m, 2), y = w[0], x = w[1];
                                    l.push(y + ': ' + x)
                                }
                            } catch (e) {
                                u = !0, g = e
                        ...
                        if (p = r.calculateObjectValue(this.options, this.options.rowAttributes, [e, t], p), p) {
                            ...
                            try {
                                for (var C, T = Object.entries(p)[Symbol.iterator](); !(S = (C = T.next()).done); S = !0) {
                                    var O = C.value, _ = i(O, 2), R = _[0], A = _[1];
                        ...
                        return a.push('<tr', r.sprintf(' %s', c.length ? c.join(' ') : void 0), r.sprintf(' id="%s"', Array.isArray(e) ? void 0 : e._id), r.sprintf(' class="%s"', s.classes || (Array.isArray(e) ? void 0 : e._class)), ' data-index="' + t + '"', r.sprintf(' data-uniqueid="%s"', e[this.options.uniqueId]), r.sprintf('%s', d), '>'), this.options.cardView && a.push('<td colspan="' + this.header.fields.length + '"><div class="card-views">'), !this.options.cardView && this.options.detailView && (a.push('<td>'), r.calculateObjectValue(null, this.options.detailFilter, [t, e]) && a.push('\n            <a class="detail-icon" href="#">\n            <i class="' + this.options.iconsPrefix + ' ' + this.options.icons.detailOpen + '"></i>\n            </a>\n          '), a.push('</td>')), this.header.fields.forEach(function (d, p) {
                            var h = '', u = r.getItemField(e, d, o.options.escape), g = '', f = '', b = {}, m = '',
                                w = o.header.classes[p], y = '', k = '', v = '', x = '', S = '', $ = o.columns[p];
                                ...
                                if ($.escape && (u = r.escapeHTML(u)), l.concat([o.header.styles[p]]).length && (y = ' style="' + l.concat([o.header.styles[p]]).join('; ') + '"'), e['_' + d + '_id'] && (m = r.sprintf(' id="%s"', e['_' + d + '_id'])), e['_' + d + '_class'] && (w = r.sprintf(' class="%s"', e['_' + d + '_class'])), e['_' + d + '_rowspan'] && (v = r.sprintf(' rowspan="%s"', e['_' + d + '_rowspan'])), e['_' + d + '_colspan'] && (x = r.sprintf(' colspan="%s"', e['_' + d + '_colspan'])), e['_' + d + '_title'] && (S = r.sprintf(' title="%s"', e['_' + d + '_title'])), b = r.calculateObjectValue(o.header, o.header.cellStyles[p], [u, e, t, d], b), b.classes && (w = ' class="' + b.classes + '"'), b.css) {
                                    ...
                                    try {
                                        for (var _, R = Object.entries(b.css)[Symbol.iterator](); !(C = (_ = R.next()).done); C = !0) {
                                            var A = _.value, I = i(A, 2), F = I[0], N = I[1];
                                            P.push(F + ': ' + N)
                                        }
                                    } catch (e) {
                                        T = !0, O = e
                            ...
                            if (-1 !== l) {
                                ...
                                var d = function (e, o) {
                                    t.$body.find('>tr:not(.no-records-found)').each(function (a, i) {
                                        var r = n(i), d = r.find(t.options.cardView ? '.card-view' : 'td').eq(l),
                                            p = e.indexOf(' '), c = e.substring(0, p), h = e.substring(p + 1);
                                        d.find(h).off(c).on(c, function (i) {
                                            var e = r.data('index'), a = t.data[e], n = a[s];
                                            o.apply(t, [i, n, a, e])
                                        })
                                    })
                                }, p = !0, c = !1, h = void 0;
                                try {
                                    for (var u, g = Object.entries(a)[Symbol.iterator](); !(p = (u = g.next()).done); p = !0) {
                                        var f = u.value, b = i(f, 2), m = b[0], w = b[1];
                                        d(m, w)
                                    }
                                } catch (e) {
                                    c = !0, h = e
                ...
                key: 'fitHeader', value: function () {
                    ...
                    var s = this.getVisibleFields(), l = this.$header_.find('th');
                ...
                key: 'updateByUniqueId', value: function (e) {
                    ...
                    try {
                        for (var s, l, r = t[Symbol.iterator](); !(o = (s = r.next()).done); o = !0) if (l = s.value, l.hasOwnProperty('id') && l.hasOwnProperty('row')) {
                            var d = this.options.data.indexOf(this.getRowByUniqueId(l.id));
                            -1 !== d && n.extend(this.options.data[d], l.row)
                        }
                    } catch (e) {
                        i = !0, a = e
                    } finally {
