...
<div class="modal fade" id="ActivityPlanAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="form" enctype="multipart/form-data" method="post" class="form-horizontal">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                    <h4 class="modal-title" id="myModalLabel2">幼儿园活动方案新增</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-md-2" for="kindergartenName" class="col-md-2 control-label">方案名称：</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="kindergartenName" name="kindergartenName" placeholder="请选择你要新增的方案模板">
                        </div>
                    </div>
...
<div class="modal fade" id="kindergartenModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title" id="myModalLabel1">幼儿园方案模板修改</h4>
            </div>
            <div class="modal-body">
                <form id="updateForm" role="form" class="form-horizontal" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="kindergartenName1" class="col-md-2 control-label">幼儿园方案名称：</label>
                        <div class="col-md-10">
