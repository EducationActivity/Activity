                                    ...
                                    <div class="item">
                                        <div class="item-image">
                                            ...
                                            <div class="item-hover">
                                                <a href="${basePath}course_detail.do" class="btn">View details</a>
                                                <div class="rating">
                                        ...
                                        <div class="item-details">
                                            <h3 class="item-title"><a href="${basePath}course_detail.do">课程名称</a></h3><!-- /.item-title -->
                                            <div class="price">
                                                <span class="current-price">课程描述</span><!-- /.current-price -->
                                            </div><!-- /.price -->
                                            <p>
