          ...
          <div class="row">
            ...
            <div class="col-lg-5 col-md-6">
              <div class="b-info-section__inner">
                <div class="ui-decor-1"><img src="${basePath}static/assets/media/general/ui-decor-1.png" alt="decor"/></div>
                <h2 class="ui-title-block"><span class="text-primary">Dvents</span> - Events That Lasts</h2>
                <div class="ui-subtitle-block">You should choose Dvents Services because we bring your guests closer to you & helps you to create a relationship that lasts long!</div>
          ...
          <div class="row">
            <div class="col-md-4">
              <section class="b-pricing">
                ...
                </ul><a href="home.html" class="b-pricing__btn btn btn-default">order now</a>
              </section>
              <!-- end .b-pricing-->
            </div>
            <div class="col-md-4">
