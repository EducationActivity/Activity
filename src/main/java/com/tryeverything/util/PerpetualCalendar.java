...
public class PerpetualCalendar {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="c3d767508534f43f98957b977c65dde3";

    public static void PerpetualCalendarUtil(String today){
        String result =null;
        String url ="http://v.juhe.cn/calendar/month";//请求接口地址
        Map params = new HashMap();//请求参数
        params.put("key",APPKEY);//您申请的appKey
        params.put("year-month",today);//指定月份,格式为YYYY-MM,如月份和日期小于10,则取个位,如:2012-1
        try {
