    ...
    e.fn.fileinputLocales = {}, e.fn.fileinputThemes = {}, String.prototype.setTokens = function (e) {
        ...
        constructor: i, _cleanup: function () {
            ...
            i = t.closeButton("fileinput-remove"), a = '<div id="' + t.MODAL_ID + '" class="file-zoom-dialog modal fade" tabindex="-1" aria-labelledby="' + t.MODAL_ID + 'Label"></div>', r = '<div class="file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}" data-template="{template}"', n = '<video class="kv-preview-data file-preview-video" controls {style}>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</video>\n", s = '\x3c!--suppress ALL --\x3e<audio class="kv-preview-data file-preview-audio" controls {style}>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</audio>\n", l = '<embed class="kv-preview-data file-preview-pdf" src="{data}" type="application/pdf" {style}>\n', o = '<object class="kv-preview-data file-preview-object file-object {typeCss}" data="{data}" type="{type}" {style}>\n<param name="movie" value="{caption}" />\n' + t.OBJECT_PARAMS + " " + t.DEFAULT_PREVIEW + "\n</object>\n", d = '<div class="kv-preview-data file-preview-other-frame" {style}>\n' + t.DEFAULT_PREVIEW + "\n</div>\n", c = {
                ...
                height: "100%",
                "min-height": "480px"
            }, h._isPdfRendered() && (l = h.pdfRendererTemplate.replace("{renderer}", h._encodeURI(h.pdfRendererUrl))), h.defaults = {
                layoutTemplates: {
            ...
            var r, n, s, o, l, d, c, h, p = this, u = i.attr("id"), f = p.$preview.find("#zoom-" + u), m = p.$modal,
                g = m.find(".btn-fullscreen"), v = m.find(".btn-borderless"), w = m.find(".btn-toggleheader");
            n = f.attr("data-template") || "generic", s = (r = f.find(".kv-file-content")).length ? r.html() : "", o = (i.data("caption") || "") + " " + (i.data("size") || ""), m.find(".kv-zoom-title").attr("title", e("<div/>").html(o).text()).html(o), l = m.find(".kv-zoom-body"), m.removeClass("kv-single-content"), a ? (h = l.addClass("file-thumb-loading").clone().insertAfter(l), l.html(s).hide(), h.fadeOut("fast", function () {
            ...
            })), m.data("previewId", u), p._handler(m.find(".btn-prev"), "click", function () {
                ...
                var e, t = m.find(".modal-header"), i = m.find(".modal-body .floating-buttons"),
                ...
                var i = t.which || t.keyCode, a = e(this).find(".btn-prev"), r = e(this).find(".btn-next"),
                    n = e(this).data("previewId"), s = p.rtl ? 39 : 37, o = p.rtl ? 37 : 39;
            ...
            var o, l, d = this;
            d._raise("filepreajax", [n, s]) && (d._uploadExtra(n, s), d._initAjaxSettings(), d._mergeAjaxCallback("beforeSend", t), d._mergeAjaxCallback("success", i), d._mergeAjaxCallback("complete", a), d._mergeAjaxCallback("error", r), l = s && d.uploadUrlThumb ? d.uploadUrlThumb : d.uploadUrl, o = e.extend(!0, {}, {
                xhr: function () {
                ...
                processData: !1,
                contentType: !1
            }, d._ajaxSettings), d.ajaxRequests.push(e.ajax(o)))
            ...
            var l, d;
            (d = (l = e.length && this.autoOrientImage ? this._getExifObj(o) : null) ? l["0th"][piexif.ImageIFD.Orientation] : null) ? (t.setImageOrientation(e, this.$preview.find("#zoom-" + a + " img"), d), this._raise("fileimageoriented", {
                $img: e,
                file: i
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(i, function (e, t) {
                ...
                var T, E, S, k, F, P, I, A, D, z, $, j, U = p + "-" + (m + x), R = i[x], B = f.text, O = f.image,
                    L = f.html, M = R && R.name ? r.slug(R.name) : "", Z = (R && R.size || 0) / 1e3, N = "",
                    H = R ? t.objUrl.createObjectURL(R) : null, W = 0, q = "", V = 0, K = function () {
                        var e = h.setTokens({index: x + 1, files: u, percent: 50, name: M});
                        setTimeout(function () {
                            d.html(e), r._updateFileDetails(u), a(x + 1)
                        }, 100), r._raise("fileloaded", [R, U, x, o])
                    };
                if (R) {
                    if (v > 0) for (E = 0; E < v; E++) P = g[E], I = r.msgFileTypes[P] || P, q += 0 === E ? I : ", " + I;
                    if (!1 !== M) {
                        if (0 === M.length) return S = r.msgInvalidFileName.replace("{name}", t.htmlEncode(R.name, "[unknown]")), void y(S, R, U, x);
                        ...
                        if (!t.isEmpty(g) && t.isArray(g)) {
                            for (E = 0; E < g.length; E += 1) k = g[E], W += (A = f[k]) && "function" == typeof A && A(R.type, R.name) ? 1 : 0;
                        ...
                        }, 100), void r._raise("fileloaded", [R, U, x, o]);
                        if (!C && Z > b) return r.addToStack(R), l.addClass("file-thumb-loading"), r._previewDefault(R, U), r._initFileActions(), r._updateFileDetails(u), void a(x + 1);
                        s.length && void 0 !== FileReader ? (D = B(R.type, M), z = L(R.type, M), $ = O(R.type, M), d.html(c.replace("{index}", x + 1).replace("{files}", u)), l.addClass("file-thumb-loading"), o.onerror = function (e) {
                            r._errorHandler(e, M)
                        }, o.onload = function (i) {
                            var a, n, s, l, d, c, h, p, u = [];
                            if (n = {name: M, type: R.type}, e.each(f, function (e, t) {
                                "object" !== e && "other" !== e && t(R.type, M) && V++
                            }), 0 === V) {
                                for (s = new Uint8Array(i.target.result), E = 0; E < s.length; E++) l = s[E].toString(16), u.push(l);
                                if (a = u.join("").toLowerCase().substring(0, 8), c = t.getMimeType(a, "", ""), t.isEmpty(c) && (d = t.arrayBuffer2String(o.result), c = t.isSvg(d) ? "image/svg+xml" : t.getMimeType(a, d, R.type)), n = {
                                    name: M,
                                    type: c
                                }, D = B(c, ""), z = L(c, ""), $ = O(c, ""), (j = D || z) || $) return h = j, (p = new FileReader).onerror = function (e) {
                                    r._errorHandler(e, M)
                                }, p.onload = function (e) {
                                    r._previewFile(x, R, e, U, H, n), r._initFileActions(), K()
                                }, void(h ? p.readAsText(R, r.textEncoding) : p.readAsDataURL(R))
                            }
                            r._previewFile(x, R, i, U, H, n), r._initFileActions(), K()
                        ...
                        }, D || z ? o.readAsText(R, r.textEncoding) : $ ? o.readAsDataURL(R) : o.readAsArrayBuffer(R)) : (r._previewDefault(R, U), setTimeout(function () {
                            a(x + 1), r._updateFileDetails(u)
                        }, 100), r._raise("fileloaded", [R, U, x, o])), r.addToStack(R)
                    } else a(x + 1)
                }
