...
<div class="main">
    ...
    <h2>欢迎加盟商</h2>
    <div class="sap_tabs">
        <div class="login-error">${franchisee_msg}</div>
            ...
            <div class="resp-tabs-container">
                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                    <div class="facts">
                        <!--login1-->
                        <div class="register">
                        <form id="registerForm" method="post" action="${basePath}franchisee/add.do">
                            ...
                            <input placeholder="姓名" type="text" id="franchiseeName" name="franchiseeName"/>
                            <input placeholder="电话" type="text" id="phone" name="phone"/>
                            <input placeholder="邮箱" type="text" id="email" name="email"/>
                            <input placeholder="所在地" type="text" id="locality" name="locality"/>
                            <div class="sign-up">
                ...
                <div class="tab-2 resp-tab-content" aria-labelledby="tab_item-1">
                    <div class="facts">
                        <div class="register">
                            <form id="loginForm" method="post" action="${basePath}franchisee/login.do">
                ...
                <a href="javascript:void(0);" onclick="skip()">物料供应商注册登录</a>
            </div>
        </div>
    </div>
    <!--start-copyright-->
...
var options = {
    url: "${basePath}franchisee/add.do", //提交地址:默认是form的action,如果申明,则会覆盖
...
function skip(){
    window.location.href = "${basePath}supplier/loginPage.do"
}
</script>
</html>
